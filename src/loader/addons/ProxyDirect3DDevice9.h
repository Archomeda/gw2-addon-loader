...
namespace loader {
    namespace addons {
        ...
        namespace d3d9_types {
            typedef HRESULT(QueryInterface_t)(IDirect3DDevice9* dev, REFIID riid, void** ppvObj);
            typedef ULONG(AddRef_t)(IDirect3DDevice9* dev);
            typedef ULONG(Release_t)(IDirect3DDevice9* dev);
            typedef HRESULT(TestCooperativeLevel_t)(IDirect3DDevice9* dev);
            typedef UINT(GetAvailableTextureMem_t)(IDirect3DDevice9* dev);
            typedef HRESULT(EvictManagedResources_t)(IDirect3DDevice9* dev);
            typedef HRESULT(GetDirect3D_t)(IDirect3DDevice9* dev, IDirect3D9** ppD3D9);
            typedef HRESULT(GetDeviceCaps_t)(IDirect3DDevice9* dev, D3DCAPS9* pCaps);
            typedef HRESULT(GetDisplayMode_t)(IDirect3DDevice9* dev, UINT iSwapChain, D3DDISPLAYMODE* pMode);
            typedef HRESULT(GetCreationParameters_t)(IDirect3DDevice9* dev, D3DDEVICE_CREATION_PARAMETERS *pParameters);
            typedef HRESULT(SetCursorProperties_t)(IDirect3DDevice9* dev, UINT XHotSpot, UINT YHotSpot, IDirect3DSurface9* pCursorBitmap);
            typedef void(SetCursorPosition_t)(IDirect3DDevice9* dev, int X, int Y, DWORD Flags);
            typedef BOOL(ShowCursor_t)(IDirect3DDevice9* dev, BOOL bShow);
            typedef HRESULT(CreateAdditionalSwapChain_t)(IDirect3DDevice9* dev, D3DPRESENT_PARAMETERS* pPresentationParameters, IDirect3DSwapChain9** pSwapChain);
            typedef HRESULT(GetSwapChain_t)(IDirect3DDevice9* dev, UINT iSwapChain, IDirect3DSwapChain9** pSwapChain);
            typedef UINT(GetNumberOfSwapChains_t)(IDirect3DDevice9* dev);
            typedef HRESULT(Reset_t)(IDirect3DDevice9* dev, D3DPRESENT_PARAMETERS* pPresentationParameters);
            typedef HRESULT(Present_t)(IDirect3DDevice9* dev, CONST RECT* pSourceRect, CONST RECT* pDestRect, HWND hDestWindowOverride, CONST RGNDATA* pDirtyRegion);
            typedef HRESULT(GetBackBuffer_t)(IDirect3DDevice9* dev, UINT iSwapChain, UINT iBackBuffer, D3DBACKBUFFER_TYPE Type, IDirect3DSurface9** ppBackBuffer);
            typedef HRESULT(GetRasterStatus_t)(IDirect3DDevice9* dev, UINT iSwapChain, D3DRASTER_STATUS* pRasterStatus);
            typedef HRESULT(SetDialogBoxMode_t)(IDirect3DDevice9* dev, BOOL bEnableDialogs);
            typedef void(SetGammaRamp_t)(IDirect3DDevice9* dev, UINT iSwapChain, DWORD Flags, CONST D3DGAMMARAMP* pRamp);
            typedef void(GetGammaRamp_t)(IDirect3DDevice9* dev, UINT iSwapChain, D3DGAMMARAMP* pRamp);
            typedef HRESULT(CreateTexture_t)(IDirect3DDevice9* dev, UINT Width, UINT Height, UINT Levels, DWORD Usage, D3DFORMAT Format, D3DPOOL Pool, IDirect3DTexture9** ppTexture, HANDLE* pSharedHandle);
            typedef HRESULT(CreateVolumeTexture_t)(IDirect3DDevice9* dev, UINT Width, UINT Height, UINT Depth, UINT Levels, DWORD Usage, D3DFORMAT Format, D3DPOOL Pool, IDirect3DVolumeTexture9** ppVolumeTexture, HANDLE* pSharedHandle);
            typedef HRESULT(CreateCubeTexture_t)(IDirect3DDevice9* dev, UINT EdgeLength, UINT Levels, DWORD Usage, D3DFORMAT Format, D3DPOOL Pool, IDirect3DCubeTexture9** ppCubeTexture, HANDLE* pSharedHandle);
            typedef HRESULT(CreateVertexBuffer_t)(IDirect3DDevice9* dev, UINT Length, DWORD Usage, DWORD FVF, D3DPOOL Pool, IDirect3DVertexBuffer9** ppVertexBuffer, HANDLE* pSharedHandle);
            typedef HRESULT(CreateIndexBuffer_t)(IDirect3DDevice9* dev, UINT Length, DWORD Usage, D3DFORMAT Format, D3DPOOL Pool, IDirect3DIndexBuffer9** ppIndexBuffer, HANDLE* pSharedHandle);
            typedef HRESULT(CreateRenderTarget_t)(IDirect3DDevice9* dev, UINT Width, UINT Height, D3DFORMAT Format, D3DMULTISAMPLE_TYPE MultiSample, DWORD MultisampleQuality, BOOL Lockable, IDirect3DSurface9** ppSurface, HANDLE* pSharedHandle);
            typedef HRESULT(CreateDepthStencilSurface_t)(IDirect3DDevice9* dev, UINT Width, UINT Height, D3DFORMAT Format, D3DMULTISAMPLE_TYPE MultiSample, DWORD MultisampleQuality, BOOL Discard, IDirect3DSurface9** ppSurface, HANDLE* pSharedHandle);
            typedef HRESULT(UpdateSurface_t)(IDirect3DDevice9* dev, IDirect3DSurface9* pSourceSurface, CONST RECT* pSourceRect, IDirect3DSurface9* pDestinationSurface, CONST POINT* pDestPoint);
            typedef HRESULT(UpdateTexture_t)(IDirect3DDevice9* dev, IDirect3DBaseTexture9* pSourceTexture, IDirect3DBaseTexture9* pDestinationTexture);
            typedef HRESULT(GetRenderTargetData_t)(IDirect3DDevice9* dev, IDirect3DSurface9* pRenderTarget, IDirect3DSurface9* pDestSurface);
            typedef HRESULT(GetFrontBufferData_t)(IDirect3DDevice9* dev, UINT iSwapChain, IDirect3DSurface9* pDestSurface);
            typedef HRESULT(StretchRect_t)(IDirect3DDevice9* dev, IDirect3DSurface9* pSourceSurface, CONST RECT* pSourceRect, IDirect3DSurface9* pDestSurface, CONST RECT* pDestRect, D3DTEXTUREFILTERTYPE Filter);
            typedef HRESULT(ColorFill_t)(IDirect3DDevice9* dev, IDirect3DSurface9* pSurface, CONST RECT* pRect, D3DCOLOR color);
            typedef HRESULT(CreateOffscreenPlainSurface_t)(IDirect3DDevice9* dev, UINT Width, UINT Height, D3DFORMAT Format, D3DPOOL Pool, IDirect3DSurface9** ppSurface, HANDLE* pSharedHandle);
            typedef HRESULT(SetRenderTarget_t)(IDirect3DDevice9* dev, DWORD RenderTargetIndex, IDirect3DSurface9* pRenderTarget);
            typedef HRESULT(GetRenderTarget_t)(IDirect3DDevice9* dev, DWORD RenderTargetIndex, IDirect3DSurface9** ppRenderTarget);
            typedef HRESULT(SetDepthStencilSurface_t)(IDirect3DDevice9* dev, IDirect3DSurface9* pNewZStencil);
            typedef HRESULT(GetDepthStencilSurface_t)(IDirect3DDevice9* dev, IDirect3DSurface9** ppZStencilSurface);
            typedef HRESULT(BeginScene_t)(IDirect3DDevice9* dev);
            typedef HRESULT(EndScene_t)(IDirect3DDevice9* dev);
            typedef HRESULT(Clear_t)(IDirect3DDevice9* dev, DWORD Count, CONST D3DRECT* pRects, DWORD Flags, D3DCOLOR Color, float Z, DWORD Stencil);
            typedef HRESULT(SetTransform_t)(IDirect3DDevice9* dev, D3DTRANSFORMSTATETYPE State, CONST D3DMATRIX* pMatrix);
            typedef HRESULT(GetTransform_t)(IDirect3DDevice9* dev, D3DTRANSFORMSTATETYPE State, D3DMATRIX* pMatrix);
            typedef HRESULT(MultiplyTransform_t)(IDirect3DDevice9* dev, D3DTRANSFORMSTATETYPE State, CONST D3DMATRIX* pMatrix);
            typedef HRESULT(SetViewport_t)(IDirect3DDevice9* dev, CONST D3DVIEWPORT9* pViewport);
            typedef HRESULT(GetViewport_t)(IDirect3DDevice9* dev, D3DVIEWPORT9* pViewport);
            typedef HRESULT(SetMaterial_t)(IDirect3DDevice9* dev, CONST D3DMATERIAL9* pMaterial);
            typedef HRESULT(GetMaterial_t)(IDirect3DDevice9* dev, D3DMATERIAL9* pMaterial);
            typedef HRESULT(SetLight_t)(IDirect3DDevice9* dev, DWORD Index, CONST D3DLIGHT9* pLight);
            typedef HRESULT(GetLight_t)(IDirect3DDevice9* dev, DWORD Index, D3DLIGHT9* pLight);
            typedef HRESULT(LightEnable_t)(IDirect3DDevice9* dev, DWORD Index, BOOL Enable);
            typedef HRESULT(GetLightEnable_t)(IDirect3DDevice9* dev, DWORD Index, BOOL* pEnable);
            typedef HRESULT(SetClipPlane_t)(IDirect3DDevice9* dev, DWORD Index, CONST float* pPlane);
            typedef HRESULT(GetClipPlane_t)(IDirect3DDevice9* dev, DWORD Index, float* pPlane);
            typedef HRESULT(SetRenderState_t)(IDirect3DDevice9* dev, D3DRENDERSTATETYPE State, DWORD Value);
            typedef HRESULT(GetRenderState_t)(IDirect3DDevice9* dev, D3DRENDERSTATETYPE State, DWORD* pValue);
            typedef HRESULT(CreateStateBlock_t)(IDirect3DDevice9* dev, D3DSTATEBLOCKTYPE Type, IDirect3DStateBlock9** ppSB);
            typedef HRESULT(BeginStateBlock_t)(IDirect3DDevice9* dev);
            typedef HRESULT(EndStateBlock_t)(IDirect3DDevice9* dev, IDirect3DStateBlock9** ppSB);
            typedef HRESULT(SetClipStatus_t)(IDirect3DDevice9* dev, CONST D3DCLIPSTATUS9* pClipStatus);
            typedef HRESULT(GetClipStatus_t)(IDirect3DDevice9* dev, D3DCLIPSTATUS9* pClipStatus);
            typedef HRESULT(GetTexture_t)(IDirect3DDevice9* dev, DWORD Stage, IDirect3DBaseTexture9** ppTexture);
            typedef HRESULT(SetTexture_t)(IDirect3DDevice9* dev, DWORD Stage, IDirect3DBaseTexture9* pTexture);
            typedef HRESULT(GetTextureStageState_t)(IDirect3DDevice9* dev, DWORD Stage, D3DTEXTURESTAGESTATETYPE Type, DWORD* pValue);
            typedef HRESULT(SetTextureStageState_t)(IDirect3DDevice9* dev, DWORD Stage, D3DTEXTURESTAGESTATETYPE Type, DWORD Value);
            typedef HRESULT(GetSamplerState_t)(IDirect3DDevice9* dev, DWORD Sampler, D3DSAMPLERSTATETYPE Type, DWORD* pValue);
            typedef HRESULT(SetSamplerState_t)(IDirect3DDevice9* dev, DWORD Sampler, D3DSAMPLERSTATETYPE Type, DWORD Value);
            typedef HRESULT(ValidateDevice_t)(IDirect3DDevice9* dev, DWORD* pNumPasses);
            typedef HRESULT(SetPaletteEntries_t)(IDirect3DDevice9* dev, UINT PaletteNumber, CONST PALETTEENTRY* pEntries);
            typedef HRESULT(GetPaletteEntries_t)(IDirect3DDevice9* dev, UINT PaletteNumber, PALETTEENTRY* pEntries);
            typedef HRESULT(SetCurrentTexturePalette_t)(IDirect3DDevice9* dev, UINT PaletteNumber);
            typedef HRESULT(GetCurrentTexturePalette_t)(IDirect3DDevice9* dev, UINT *PaletteNumber);
            typedef HRESULT(SetScissorRect_t)(IDirect3DDevice9* dev, CONST RECT* pRect);
            typedef HRESULT(GetScissorRect_t)(IDirect3DDevice9* dev, RECT* pRect);
            typedef HRESULT(SetSoftwareVertexProcessing_t)(IDirect3DDevice9* dev, BOOL bSoftware);
            typedef BOOL(GetSoftwareVertexProcessing_t)(IDirect3DDevice9* dev);
            typedef HRESULT(SetNPatchMode_t)(IDirect3DDevice9* dev, float nSegments);
            typedef float(GetNPatchMode_t)(IDirect3DDevice9* dev);
            typedef HRESULT(DrawPrimitive_t)(IDirect3DDevice9* dev, D3DPRIMITIVETYPE PrimitiveType, UINT StartVertex, UINT PrimitiveCount);
            typedef HRESULT(DrawIndexedPrimitive_t)(IDirect3DDevice9* dev, D3DPRIMITIVETYPE PrimitiveType, INT BaseVertexIndex, UINT MinVertexIndex, UINT NumVertices, UINT startIndex, UINT primCount);
            typedef HRESULT(DrawPrimitiveUP_t)(IDirect3DDevice9* dev, D3DPRIMITIVETYPE PrimitiveType, UINT PrimitiveCount, CONST void* pVertexStreamZeroData, UINT VertexStreamZeroStride);
            typedef HRESULT(DrawIndexedPrimitiveUP_t)(IDirect3DDevice9* dev, D3DPRIMITIVETYPE PrimitiveType, UINT MinVertexIndex, UINT NumVertices, UINT PrimitiveCount, CONST void* pIndexData, D3DFORMAT IndexDataFormat, CONST void* pVertexStreamZeroData, UINT VertexStreamZeroStride);
            typedef HRESULT(ProcessVertices_t)(IDirect3DDevice9* dev, UINT SrcStartIndex, UINT DestIndex, UINT VertexCount, IDirect3DVertexBuffer9* pDestBuffer, IDirect3DVertexDeclaration9* pVertexDecl, DWORD Flags);
            typedef HRESULT(CreateVertexDeclaration_t)(IDirect3DDevice9* dev, CONST D3DVERTEXELEMENT9* pVertexElements, IDirect3DVertexDeclaration9** ppDecl);
            typedef HRESULT(SetVertexDeclaration_t)(IDirect3DDevice9* dev, IDirect3DVertexDeclaration9* pDecl);
            typedef HRESULT(GetVertexDeclaration_t)(IDirect3DDevice9* dev, IDirect3DVertexDeclaration9** ppDecl);
            typedef HRESULT(SetFVF_t)(IDirect3DDevice9* dev, DWORD FVF);
            typedef HRESULT(GetFVF_t)(IDirect3DDevice9* dev, DWORD* pFVF);
            typedef HRESULT(CreateVertexShader_t)(IDirect3DDevice9* dev, CONST DWORD* pFunction, IDirect3DVertexShader9** ppShader);
            typedef HRESULT(SetVertexShader_t)(IDirect3DDevice9* dev, IDirect3DVertexShader9* pShader);
            typedef HRESULT(GetVertexShader_t)(IDirect3DDevice9* dev, IDirect3DVertexShader9** ppShader);
            typedef HRESULT(SetVertexShaderConstantF_t)(IDirect3DDevice9* dev, UINT StartRegister, CONST float* pConstantData, UINT Vector4fCount);
            typedef HRESULT(GetVertexShaderConstantF_t)(IDirect3DDevice9* dev, UINT StartRegister, float* pConstantData, UINT Vector4fCount);
            typedef HRESULT(SetVertexShaderConstantI_t)(IDirect3DDevice9* dev, UINT StartRegister, CONST int* pConstantData, UINT Vector4iCount);
            typedef HRESULT(GetVertexShaderConstantI_t)(IDirect3DDevice9* dev, UINT StartRegister, int* pConstantData, UINT Vector4iCount);
            typedef HRESULT(SetVertexShaderConstantB_t)(IDirect3DDevice9* dev, UINT StartRegister, CONST BOOL* pConstantData, UINT BoolCount);
            typedef HRESULT(GetVertexShaderConstantB_t)(IDirect3DDevice9* dev, UINT StartRegister, BOOL* pConstantData, UINT BoolCount);
            typedef HRESULT(SetStreamSource_t)(IDirect3DDevice9* dev, UINT StreamNumber, IDirect3DVertexBuffer9* pStreamData, UINT OffsetInBytes, UINT Stride);
            typedef HRESULT(GetStreamSource_t)(IDirect3DDevice9* dev, UINT StreamNumber, IDirect3DVertexBuffer9** ppStreamData, UINT* pOffsetInBytes, UINT* pStride);
            typedef HRESULT(SetStreamSourceFreq_t)(IDirect3DDevice9* dev, UINT StreamNumber, UINT Setting);
            typedef HRESULT(GetStreamSourceFreq_t)(IDirect3DDevice9* dev, UINT StreamNumber, UINT* pSetting);
            typedef HRESULT(SetIndices_t)(IDirect3DDevice9* dev, IDirect3DIndexBuffer9* pIndexData);
            typedef HRESULT(GetIndices_t)(IDirect3DDevice9* dev, IDirect3DIndexBuffer9** ppIndexData);
            typedef HRESULT(CreatePixelShader_t)(IDirect3DDevice9* dev, CONST DWORD* pFunction, IDirect3DPixelShader9** ppShader);
            typedef HRESULT(SetPixelShader_t)(IDirect3DDevice9* dev, IDirect3DPixelShader9* pShader);
            typedef HRESULT(GetPixelShader_t)(IDirect3DDevice9* dev, IDirect3DPixelShader9** ppShader);
            typedef HRESULT(SetPixelShaderConstantF_t)(IDirect3DDevice9* dev, UINT StartRegister, CONST float* pConstantData, UINT Vector4fCount);
            typedef HRESULT(GetPixelShaderConstantF_t)(IDirect3DDevice9* dev, UINT StartRegister, float* pConstantData, UINT Vector4fCount);
            typedef HRESULT(SetPixelShaderConstantI_t)(IDirect3DDevice9* dev, UINT StartRegister, CONST int* pConstantData, UINT Vector4iCount);
            typedef HRESULT(GetPixelShaderConstantI_t)(IDirect3DDevice9* dev, UINT StartRegister, int* pConstantData, UINT Vector4iCount);
            typedef HRESULT(SetPixelShaderConstantB_t)(IDirect3DDevice9* dev, UINT StartRegister, CONST BOOL* pConstantData, UINT BoolCount);
            typedef HRESULT(GetPixelShaderConstantB_t)(IDirect3DDevice9* dev, UINT StartRegister, BOOL* pConstantData, UINT BoolCount);
            typedef HRESULT(DrawRectPatch_t)(IDirect3DDevice9* dev, UINT Handle, CONST float* pNumSegs, CONST D3DRECTPATCH_INFO* pRectPatchInfo);
            typedef HRESULT(DrawTriPatch_t)(IDirect3DDevice9* dev, UINT Handle, CONST float* pNumSegs, CONST D3DTRIPATCH_INFO* pTriPatchInfo);
            typedef HRESULT(DeletePatch_t)(IDirect3DDevice9* dev, UINT Handle);
            typedef HRESULT(CreateQuery_t)(IDirect3DDevice9* dev, D3DQUERYTYPE Type, IDirect3DQuery9** ppQuery);
            typedef HRESULT(SetConvolutionMonoKernel_t)(IDirect3DDevice9* dev, UINT width, UINT height, float* rows, float* columns);
            typedef HRESULT(ComposeRects_t)(IDirect3DDevice9* dev, IDirect3DSurface9* pSrc, IDirect3DSurface9* pDst, IDirect3DVertexBuffer9* pSrcRectDescs, UINT NumRects, IDirect3DVertexBuffer9* pDstRectDescs, D3DCOMPOSERECTSOP Operation, int Xoffset, int Yoffset);
            typedef HRESULT(PresentEx_t)(IDirect3DDevice9* dev, CONST RECT* pSourceRect, CONST RECT* pDestRect, HWND hDestWindowOverride, CONST RGNDATA* pDirtyRegion, DWORD dwFlags);
            typedef HRESULT(GetGPUThreadPriority_t)(IDirect3DDevice9* dev, INT* pPriority);
            typedef HRESULT(SetGPUThreadPriority_t)(IDirect3DDevice9* dev, INT Priority);
            typedef HRESULT(WaitForVBlank_t)(IDirect3DDevice9* dev, UINT iSwapChain);
            typedef HRESULT(CheckResourceResidency_t)(IDirect3DDevice9* dev, IDirect3DResource9** pResourceArray, UINT32 NumResources);
            typedef HRESULT(SetMaximumFrameLatency_t)(IDirect3DDevice9* dev, UINT MaxLatency);
            typedef HRESULT(GetMaximumFrameLatency_t)(IDirect3DDevice9* dev, UINT* pMaxLatency);
            typedef HRESULT(CheckDeviceState_t)(IDirect3DDevice9* dev, HWND hDestinationWindow);
            typedef HRESULT(CreateRenderTargetEx_t)(IDirect3DDevice9* dev, UINT Width, UINT Height, D3DFORMAT Format, D3DMULTISAMPLE_TYPE MultiSample, DWORD MultisampleQuality, BOOL Lockable, IDirect3DSurface9** ppSurface, HANDLE* pSharedHandle, DWORD Usage);
            typedef HRESULT(CreateOffscreenPlainSurfaceEx_t)(IDirect3DDevice9* dev, UINT Width, UINT Height, D3DFORMAT Format, D3DPOOL Pool, IDirect3DSurface9** ppSurface, HANDLE* pSharedHandle, DWORD Usage);
            typedef HRESULT(CreateDepthStencilSurfaceEx_t)(IDirect3DDevice9* dev, UINT Width, UINT Height, D3DFORMAT Format, D3DMULTISAMPLE_TYPE MultiSample, DWORD MultisampleQuality, BOOL Discard, IDirect3DSurface9** ppSurface, HANDLE* pSharedHandle, DWORD Usage);
            typedef HRESULT(ResetEx_t)(IDirect3DDevice9* dev, D3DPRESENT_PARAMETERS* pPresentationParameters, D3DDISPLAYMODEEX* pFullscreenDisplayMode);
            typedef HRESULT(GetDisplayModeEx_t)(IDirect3DDevice9* dev, UINT iSwapChain, D3DDISPLAYMODEEX* pMode, D3DDISPLAYROTATION* pRotation);
        }
